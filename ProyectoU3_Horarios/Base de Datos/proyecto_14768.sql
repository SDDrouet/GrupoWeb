...
--
-- Servidor: localhost
-- Tiempo de generación: 09-03-2024 a las 23:23:40
...
--
ALTER TABLE `horarios_aulas`
  MODIFY `id_horario__aula` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1270;

--
-- AUTO_INCREMENT de la tabla `horarios_aulas_cursos`
--
ALTER TABLE `horarios_aulas_cursos`
  MODIFY `id_horarios_aulas_cursos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `periodos_docentes`
  MODIFY `id_periodo_docente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `periodos_horarios`
--
ALTER TABLE `periodos_horarios`
  MODIFY `id_periodo_horario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
