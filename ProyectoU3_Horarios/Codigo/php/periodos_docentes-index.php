                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . htmlspecialchars($row['id_periodo_docente']) . "</td>";echo "<td>" . htmlspecialchars($row['id_periodo']) . "</td>";echo "<td>" . htmlspecialchars($row['id_docente']) . "</td>";echo "<td>" . htmlspecialchars($row['horas_asignadas']) . "</td>";
                                        echo "<td>";
