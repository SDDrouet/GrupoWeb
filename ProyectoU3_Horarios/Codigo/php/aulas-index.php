        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $orderBy = array('id_aula', 'capacidad', 'bloque', 'observacion');
                    $order = 'id_aula';
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th><a href=?search=$search&sort=&order=id_aula&sort=$sort>ID Aula</th>";
										...
										echo "<th><a href=?search=$search&sort=&order=observacion&sort=$sort>Observaciónes</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . htmlspecialchars($row['id_aula']) . "</td>";echo "<td>" . htmlspecialchars($row['capacidad']) . "</td>";echo "<td>" . htmlspecialchars($row['bloque']) . "</td>";echo "<td>" . htmlspecialchars($row['observacion']) . "</td>";
                                        echo "<td>";
