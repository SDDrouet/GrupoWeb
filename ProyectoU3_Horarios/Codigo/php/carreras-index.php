            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Carreras Detalles</h2>
                        <a href="carreras-create.php" class="btn btn-success float-right">Nuevo registro</a>
                    ...
                    $orderBy = array('id_carrera', 'nombre_carrera');
                    $order = 'id_carrera';
                    ...
                    if(!empty($_GET['search'])) {
                        ...
                        $sql = "SELECT * FROM carreras
                            WHERE CONCAT_WS (id_carrera,nombre_carrera)
                            LIKE '%$search%'
                            ORDER BY $order $sort
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th><a href=?search=$search&sort=&order=id_carrera&sort=$sort>ID Carrera</th>";
										echo "<th><a href=?search=$search&sort=&order=nombre_carrera&sort=$sort>Nombre Carrera</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . htmlspecialchars($row['id_carrera']) . "</td>";echo "<td>" . htmlspecialchars($row['nombre_carrera']) . "</td>";
                                        echo "<td>";
