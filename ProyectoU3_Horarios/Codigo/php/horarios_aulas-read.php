                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            <h4>Horario</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["id_horario"]); ?></p>
                        </div><div class="form-group">
                            <h4>Aula</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["id_aula"]); ?></p>
                        </div><div class="form-group">
                            <h4>Disponible</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["disponible"]); ?></p>
                        </div>
