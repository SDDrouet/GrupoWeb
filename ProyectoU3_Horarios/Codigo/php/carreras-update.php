                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" name="nombre_carrera" maxlength="100"class="form-control" value="<?php echo $nombre_carrera; ?>">
                                <span class="form-text"><?php echo $nombre_carrera_err; ?></span>
                            </div>
