                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" name="tipo_perfil" maxlength="45"class="form-control" value="<?php echo $tipo_perfil; ?>">
                                <span class="form-text"><?php echo $tipo_perfil_err; ?></span>
                            </div>
						<div class="form-group">
                                <label>Privilegios</label>
                                <input type="text" name="privilegios" maxlength="300"class="form-control" value="<?php echo $privilegios; ?>">
                                <span class="form-text"><?php echo $privilegios_err; ?></span>
                            </div>
