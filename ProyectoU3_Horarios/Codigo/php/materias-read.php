                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            ...
                            <p class="form-control-static"><?php echo htmlspecialchars($row["cod_materia"]); ?></p>
                        </div><div class="form-group">
                            <h4>Nombre de la Materia</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["nombre_materia"]); ?></p>
                        </div><div class="form-group">
                            <h4>Departamento</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["departamento"]); ?></p>
                        </div><div class="form-group">
                            <h4>Horas semanales</h4>
                            <p class="form-control-static"><?php echo htmlspecialchars($row["horas_semana"]); ?></p>
                        </div>
