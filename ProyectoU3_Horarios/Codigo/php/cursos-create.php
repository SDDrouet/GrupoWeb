                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="form-group">
                                <label>NRC</label>
                                <input type="number" min="1" id="nrc" name="nrc" class="form-control" value="<?php echo $nrc; ?>">
                        ...
                        <div class="form-group">   
                            <label>Periodo</label>
                            <select class="form-control" name="periodos_id_periodo" id="periodos_id_periodo" onchange="actualizarSelectores()">
                                <?php
						...
						<div class="form-group">
                                ...
                                <span class="form-text"><?php echo $aula_horario_err; ?></span>
                            </div>
