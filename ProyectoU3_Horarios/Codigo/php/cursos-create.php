...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO cursos (periodos_id_periodo,cod_materia,horarios_id_horario,id_aula,id_docente) VALUES (?,?,?,?,?)");

        if($stmt->execute([ $periodos_id_periodo,$cod_materia,$horarios_id_horario,$id_aula,$id_docente  ])) {
                $stmt = null;
