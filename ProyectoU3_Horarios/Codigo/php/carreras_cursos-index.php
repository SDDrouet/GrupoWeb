            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Asignar carrera a curso Detalles</h2>
                        <a href="carreras_cursos-create.php" class="btn btn-success float-right">Nuevo registro</a>
                        <a href="carreras_cursos-index.php" class="btn btn-info float-right mr-2">Refrescar</a>
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . htmlspecialchars($row['id_carrera_curso']) . "</td>";echo "<td>" . htmlspecialchars($row['id_carrera']) . "</td>";echo "<td>" . htmlspecialchars($row['id_curso']) . "</td>";
                                        echo "<td>";
